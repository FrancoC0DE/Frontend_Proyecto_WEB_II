 ...
 * fuente/tamaño se guardaban en localStorage bajo claves 'guardia-font' /
 * 'guardia-fontSize' (por eso persistían por dispositivo, no por cuenta).
 * Ahora los 4 selects usan PreferenciasContext, igual que InquilinoConfig.
 * ============================================================================
 */
...
export default function GuardiaConfig() {
  const { tema, fuente, tamanoFuente, setTema, setFuente, setTamanoFuente } = usePreferencias();
